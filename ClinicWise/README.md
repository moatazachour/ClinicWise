...
│ NationalNo   │     │ PatientID(PK)│     │ DoctorID (PK)│
│ FirstName    │     │ GuardianID   │────►│Specialization│
│ LastName     │     └──────────────┘     └──────────────┘
│ DateOfBirth  │              │                   │
│ Gender       │              ▼                   │
│ Phone        │     ┌──────────────┐             │
│ Email        │     │ Appointments │◄────────────┘
│ Address      │     ├──────────────┤
│ ImagePath    │     │AppointmentID │
│ CreatedBy    │     │ DoctorID (FK)│
└──────────────┘     │PatientID (FK)│
                     │ Date         │
                     │ Status       │
                     │ ScheduledBy  │
...
┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│   Guardians  │     │    Users     │     │    Roles     │
├──────────────┤     ├──────────────┤     ├──────────────┤
│ GuardianID   │     │ UserID (PK)  │     │ RoleID (PK)  │
│ PersonID (FK)│     │ PersonID (FK)│     │ RoleName     │
│ Relationship │     │ Username     │     │ - Admin      │
└──────────────┘     │ Password     │     │ - Doctor     │
                     │ RoleID (FK)  │────►│ - Staff      │
                     │ IsActive     │     └──────────────┘
                     └──────────────┘
